...
<nav class="nav-area">
	<ul class="nav-ul">
		...
		<li><a
			href="${contextPath}/member/myPage/follow?mode=1&memberNo=${loginMember.memberNo}">팔로워
				목록</a></li>
		<li><a
			href="${contextPath}/member/myPage/follow?mode=2&memberNo=${loginMember.memberNo}">팔로잉
				목록</a></li>
