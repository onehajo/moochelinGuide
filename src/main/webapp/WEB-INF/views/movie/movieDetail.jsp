...
<head>
    ...
    <link  id="cssTest2" rel="stylesheet" href="css/header-white.css">
    <link rel="stylesheet" href="css/Detail_ev.css">
...
<dody>
    <div id="wrapper">
        ...
        <div class="backrel">
            <div class="bakcground" style="background-image: url(css/image/gwanggiyi-dajungujueseo-dagteo-seuteureinji-byeogji-3440x1440_15.jpg);"></div>
        </div>

        <div class="content-wrap">
            <div class="info-head">
                <div class="info-img">
                    <img src="css/image/VFz7DVf6CB4HlTlfxNx3vw.jpg">
                </div>
                <div class="info-text">
                    ...
                    <div style="display: inline-block;">
                        <img style="width: 16px;" src="./css/image/write_icon.png"><button id="btn-modal">코멘트</button>
                    </div>
                </div>
            </div>
            <div class="info">
