...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" href="${contextPath}/resources/css/allMovie.css.css">
        ...
        <section class="content-main">
            ...
            <fieldset class="field">
                <select name="category">
                    ...
                    <option value="Sequence">가나다순</option>
                        ...
                        <a href="resources/yjg/Detail_page.html">
                            <div class="movie">
                                ...
                                <div class="movie-bottom">
                                    ...
                                    <div class="showing-info">예매율 59% ・ 누적 관객 407만명</div>
                                </div>
                            </div>
                        </a>
                    </li>
