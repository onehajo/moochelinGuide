                            ...
                            <c:forEach var="f" items="${fList}">
                                <li class="list">
                                    ...
                                    <div class="userMessage">
                                        <a href="${contextPath}/member/myPage/message/detail?type=send&no=-1&targetNo=${f.memberNo}&count2=${fn:length(fList)}&name=${f.memberName}" onclick="window.open(this.href, '_blank', 'width=380, height=410, scrollbars=no, top=200, left=400'); return false;">
