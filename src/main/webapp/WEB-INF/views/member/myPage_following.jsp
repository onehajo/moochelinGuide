                            ...
                            <c:forEach var="f" items="${fList}">
                                <li>
                                    ...
                                    <div class="userMessage">
                                        <a href="${contextPath}/member/myPage/message/detail?type=send&no=-2&targetNo=${f.targetNo}&count2=${fn:length(fList)}" onclick="window.open(this.href, '_blank', 'width=380, height=410, scrollbars=no, top=200, left=400'); return false;">
